...
const Rings = () => {
  return (
    <>
      <div className="absolute top-1/2 left-1/2 w-[65.875rem] aspect-square border border-gray-400/20 rounded-full -translate-x-1/2 -translate-y-1/2 blur-sm opacity-90" />
      <div className="absolute top-1/2 left-1/2 w-[51.375rem] aspect-square border border-gray-400/20 rounded-full -translate-x-1/2 -translate-y-1/2 blur-sm opacity-90" />
      <div className="absolute top-1/2 left-1/2 w-[36.125rem] aspect-square border border-gray-400/20 rounded-full -translate-x-1/2 -translate-y-1/2 blur-sm opacity-90" />
      <div className="absolute top-1/2 left-1/2 w-[23.125rem] aspect-square border border-gray-400/20 rounded-full -translate-x-1/2 -translate-y-1/2 blur-sm opacity-90" />
    </>
  );
};
